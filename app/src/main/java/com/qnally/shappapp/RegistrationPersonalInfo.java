...
public class RegistrationPersonalInfo extends AppCompatActivity {
   ...
   public static TextView city, state, zip;
    Button nextbtn;
    Intent topayment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone = (EditText) findViewById(R.id.phone_number_form);
        city = (TextView) findViewById(R.id.city_form);
        state = (TextView) findViewById(R.id.state_form);
        zip = (TextView) findViewById(R.id.zipcode_form);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    //After entering text fields this will create an account object
                    Account newAccount= new Account(email.getText().toString(),firstname.getText().toString(),lastname.getText().toString(),phone.getText().toString());
                    newAccount.setShipping(address.getText().toString(),city.getText().toString(),state.getText().toString(),zip.getText().toString());
                    //let account info not be fully entered until after billing info on next page
