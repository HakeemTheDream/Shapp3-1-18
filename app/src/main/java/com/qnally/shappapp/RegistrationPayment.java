...
public class RegistrationPayment extends AppCompatActivity implements OnCardFormSubmitListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bcity = (TextView) findViewById(R.id.city_form);
        bstate = (TextView) findViewById(R.id.state_form);
        bzip = (TextView) findViewById(R.id.zipcode_form);
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((bill_check.isChecked())){
                    if(!card_name.getText().toString().equals("")){
                        info_filled = true;
                         currentBilling= new Billing(RegistrationPersonalInfo.newAccount.getShipping().getAddress(),RegistrationPersonalInfo.newAccount.getShipping().getCity()
                        ,RegistrationPersonalInfo.newAccount.getShipping().getState(),RegistrationPersonalInfo.newAccount.getShipping().getZip());
                    }
                }else{
                ...
                if(info_filled) {
                    RegistrationPersonalInfo.newAccount.setFinance(new Credit(card_name.getText().toString(),mCardForm.getCardNumber().toString(),mCardForm.getCvv().toString()
                    ,mCardForm.getExpirationMonth().toString(),mCardForm.getExpirationYear().toString()),currentBilling);
